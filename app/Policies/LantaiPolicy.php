...
class LantaiPolicy
{
    ...
    {
        return $user->can('view_any_lantai');
    }
    ...
    {
        return $user->can('delete_any_lantai');
    }
    ...
    {
        return $user->can('force_delete_any_lantai');
    }
    ...
    {
        return $user->can('restore_any_lantai');
    }
    ...
    {
        return $user->can('reorder_lantai');
    }
